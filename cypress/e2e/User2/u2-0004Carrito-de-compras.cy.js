describe('Verificar funcionalidad del Botón "Add to Cart" para Sauce Labs Bolt T-Shirt', () => {
    before(() => {
    ...
    it('Debería permitir agregar el producto "Sauce Labs Bolt T-Shirt" al carrito', () => {
        // Paso 1: Navegar a la página de productos después de iniciar sesión
        cy.url().should('include', '/inventory.html');

        // Paso 2: Identificar el producto "Sauce Labs Bolt T-Shirt" y hacer clic en "Add to cart"
        cy.get('[data-test="inventory-item-name"]').contains('Sauce Labs Bolt T-Shirt')
