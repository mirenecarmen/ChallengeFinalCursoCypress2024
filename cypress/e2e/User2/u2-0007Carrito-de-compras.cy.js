describe('Verificar funcionalidad del Botón "Add to Cart" para Sauce Labs Fleece Jacket', () => {
    before(() => {
    ...
    it('Debería permitir agregar el producto "Sauce Labs Fleece Jacket" al carrito', () => {
        // Paso 1: Navegar a la página de productos después de iniciar sesión
        cy.url().should('include', '/inventory.html');

        // Paso 2: Identificar el producto "Sauce Labs Fleece Jacket" y hacer clic en "Add to cart"
        cy.get('[data-test="inventory-item-name"]').contains('Sauce Labs Fleece Jacket')
